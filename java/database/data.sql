...
VALUES 
('The Electric Echoes', 'An innovative indie rock band known for their electrifying performances and unique soundscapes.', 4, NULL, 1),
('Jazz Junction', 'A group of seasoned jazz musicians blending classic and modern jazz styles.', 5, NULL, 1),
('Harmony Hive', 'A dynamic pop band with catchy tunes and vibrant stage presence.', 6, NULL, 1),
('Bluegrass Rebels', 'A bluegrass band with a contemporary twist, known for their soulful melodies.', 3, NULL, 1),
('The Velvet Suns', 'A rock band with a flair for dramatic, high-energy performances.', 5, NULL, 1),
('Sonic Synthesis', 'An experimental band merging electronic and acoustic sounds.', 4, NULL, 1),
('The Groove Makers', 'A funk band known for their groovy basslines and infectious rhythms.', 6, NULL, 1),
('Lyrical Legends', 'A hip-hop group with sharp lyrics and powerful beats.', 2, NULL, 1),
('The Serene Strings', 'A classical ensemble bringing a fresh perspective to traditional compositions.', 4, NULL, 1),
('Rhythm Raiders', 'A reggae band infusing classic reggae with modern influences.', 5, NULL, 1);
